...
import GetAetherBal from './components/getAetherBal';
...
const Swap = () => {
	const { actorSwap, actorIcpLedger, actorTokenomics, actorLbry, actorAether } = useSession();
	...
	return (
		<div className='custom-container'>
			<div className='account-container bg-white shadow-lg'>
				...
				<GetAetherBal actorAether={actorAether} />
			</div>
			...
			<div className='swap-container-wrapper flex gap-5 justify-center'>
				<div className='swap-container bg-white shadow-lg'>
					<div className='header'>
						<h1 className='text-center mb-5'>Stake AETHER</h1>
					</div>
					<GetStakedInfo actorSwap={actorSwap} isAuthenticated={isAuthenticated} />
					<PerformStake actorSwap={actorSwap} actorAether={actorAether} isAuthenticated={isAuthenticated} />
				</div>
			</div>
			<div className='swap-container-wrapper flex gap-5 justify-center'>
				<div className='swap-container bg-white shadow-lg'>
					...
					<TransferTokens actorIcpLedger={actorIcpLedger} actorLbry={actorLbry} actorAether={actorAether} isAuthenticated={isAuthenticated} />
				</div>
			</div>
