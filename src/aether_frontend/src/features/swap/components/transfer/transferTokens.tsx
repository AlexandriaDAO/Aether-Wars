...
const TransferTokens: React.FC<TransferTokensProps> = ({ actorIcpLedger, actorLbry, actorAether, isAuthenticated }) => {
    ...
    const handleSubmit = (event: any) => {
        ...
        else if (tokenType === "AETHER") {
            dispatch(transferAETHER({
                actorAether: actorAether,
                amount: amount,
                destination: destination,
            }))
        }
